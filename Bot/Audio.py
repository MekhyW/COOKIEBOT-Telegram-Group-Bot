...
def Speech_to_text(cookiebot, msg, chat_id, sfw, content, language):
    ...
    config = speech.RecognitionConfig(encoding='LINEAR16', language_code=language_code, alternative_language_codes=["en-US"], speech_contexts=[speechContexts], enable_word_confidence=True, enable_automatic_punctuation=True, profanity_filter=profanityFilter, enable_spoken_emojis=True, model="command_and_search", use_enhanced=True,)
