...
def thread_function(msg):
    try:
        ...
        if 'group_chat_created' in msg and msg['group_chat_created']:
            ...
            elif not CheckHumanFactor(cookiebot, msg, chat_id, language) and not CheckCAS(cookiebot, msg, chat_id, language) and not CheckBlacklist(cookiebot, msg, chat_id, language) and not CheckEvildb(cookiebot, msg, chat_id, language) and not CheckSpamwatch(cookiebot, msg, chat_id, language):
            ...
            if msg['text'].startswith("/") and len(msg['text']) > 1:
                ...
                elif msg['text'].startswith(("/patas", "/bff", "/fursmeet")):
