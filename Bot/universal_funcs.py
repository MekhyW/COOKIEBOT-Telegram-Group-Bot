...
def send_message(cookiebot, chat_id, text, msg_to_reply=None, language="pt", thread_id=None, is_alternate_bot=0, reply_markup=None, link_preview_options=None, disable_notification=False, parse_mode='HTML'):
    try:
        ...
        if msg_to_reply and link_preview_options:
            ...
            params = {'chat_id': chat_id, 'text': text, 'reply_markup': reply_markup, 'link_preview_options': link_preview_options, 'disable_notification': disable_notification, 'parse_mode': parse_mode, 'message_thread_id': int(msg_to_reply['message_thread_id']) if msg_to_reply and 'message_thread_id' in msg_to_reply else None}
